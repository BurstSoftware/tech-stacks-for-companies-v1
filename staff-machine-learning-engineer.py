...
st.title("Staff Machine Learning Engineer Application")
st.subheader("Position: Atlanta, GA - Remote, Full-time")
st.write("Salary Range: $200,000 - $270,000 per year")
st.write(f"Last Updated: {datetime.now().strftime('%I:%M %p CDT, %B %d, %Y')}")  # Updated to 07:45 PM CDT, July 22, 2025

# Job Description
st.write("""
This page is designed to help you prepare for the Staff Machine Learning Engineer role. Below are the recommended skills to align with the job qualifications.
""")
